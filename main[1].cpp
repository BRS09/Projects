...
int main(){
	...
	******************************************************************************************************************/
	cout << "| " << "Subtotal" << setw(9) << setfill(' ') << "| "  << setw(17) << setfill(' ') << "| " << subTotal << setw(9) << setfill(' ') << "|" << endl;
	cout << setw(52) << setfill('-') << "-" << endl;
	cout << "| " << "Tax" << setw(14) << setfill(' ') << "| "  << setw(17) << setfill(' ') << "| " << subTotal * TAX << setw(10) << setfill(' ') << "|" << endl;
	cout << setw(52) << setfill('-') << "-" << endl;
	cout << "| " << "Shipping" << setw(9) << setfill(' ') << "| "  << setw(17) << setfill(' ') << "| " << SHIPPING << setw(11) << setfill(' ') << "|" << endl;
	cout << setw(52) << setfill('-') << "-" << endl;
	cout << "| " << "Grand Total" << setw(6) << setfill(' ') << "| "  << setw(17) << setfill(' ') << "| " << grandTotal << setw(9) << setfill(' ') << "|" << endl;
	cout << setw(52) << setfill('-') << "-" << endl;
